    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 bg-[var(--bg-base)] pt-safe pb-safe">
      ...
      >
        <Card className="p-6 w-full">
          <div className="mb-8">
            <h1 className="font-display font-bold text-[22px] text-[var(--text-primary)] mb-1">Welcome back</h1>
            <p className="font-sans text-[13px] text-[var(--text-secondary)]">Sign in to continue directing.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4 mb-6">
            ...
            <div className="flex justify-end">
              <Link to="/forgot-password" className="font-sans text-[13px] text-[var(--amber-500)] hover:text-[var(--amber-400)] transition-colors">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="text-center">
            <Link to="/signup" className="font-sans text-[14px] font-semibold text-[var(--amber-500)] hover:text-[var(--amber-400)] transition-colors">
